...
export default function PostsPage() {
  ...
  const fetchPosts = async () => {
    try {
      ...
      alert("Network error fetching posts. Check your connection or server logs.")
    } finally {
      setLoading(false)
    }
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Submitting Post. Mode:", isEditing ? "EDIT" : "CREATE", "AuthorID:", authorId);
          ...
          {posts.map((post, index) => (
            <div key={post.id}>
              <Card className="overflow-hidden hover:shadow-lg transition-shadow">
                <Link href={`/posts/${post.id}`} className="cursor-pointer block">
                    {post.coverImage && (
