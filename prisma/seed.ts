...
const neonUrl =
	"postgresql://neondb_owner:npg_Zwft1SOLCg2B@ep-restless-lake-ahetnrw5-pooler.c-3.us-east-1.aws.neon.tech:5432/neondb?sslmode=require&pgbouncer=true&connection_limit=1";
...
async function main() {
	...
	console.log("Post Admin created: admin@gmail.com");
